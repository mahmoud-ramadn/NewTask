  ...
  <div class=" min-h-screen">
    ...
    <div class="container mx-auto">
      <div class="grid md:grid-cols-5 grid-cols-1 gap-4">
        ...
        <div
          class="md:col-span-4 col-span-1 flex flex-col justify-between h-[967px]"
        >
          <!-- part one -->
          <div class="md:h-[464px] grid md:grid-cols-5 gap-6 grid-cols-1">
            <div class="md:col-span-2 col-span-1 h-full px-8">
              <img class="w-full" src="../public/img/Labtop.svg" alt="" />

              <div class="h-20 flex justify-between">
                <div class="h-[73px] w-[73px] border-[1px]"></div>
                <div class="h-[73px] w-[73px] border-[1px]"></div>
                <div class="h-[73px] w-[73px] border-[1px]"></div>
                <div class="h-[73px] w-[73px] border-[1px]"></div>
              </div>
            ...
            <div class="md:col-span-3 col-span-1 h-full">
              <div class="flex flex-col justify-between md:h-[134px]">
                ...
                <div class="flex justify-between w-[270px]  mb-3">
                  ...
                  <div v-for="(color, index) in CircelsColor" :key="index" class="flex items-center gap-4">
                   <div
        ...
        @click="setActive(index)">
                ...
                <div class="flex justify-between w-[270px] mt-3  ">
                  ...
                  <el-dropdown>
      <el-button  style="  background-color:  transparent; width: 116px;  height: 38px;" >
          <span>  XS  </span>     <Icon name="raphael:arrowdown" width="36px" height="36px"  style="color: #f0f0f0;" />
      </el-button>
      <template #dropdown>
        <el-dropdown-menu>
          ...
          <div class="md:h-[428px]">
            ...
            <el-carousel indicator-position="outside">
              ...
              >
                ...
                >
                  <img
                    class="h-[153px]  w-full "
                    :src="product.imge"
                    alt=""
                  />
                  <h1   class=" font-semibold text-darkblue text-sm">{{ product.title }}</h1>
      ...
      <div class=" w-full">
         <h1 class="  text-center  font-bold text3xl text-darkblue ">RELATED PRODUCTS</h1>
